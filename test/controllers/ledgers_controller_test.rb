...
class LedgersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ledger" do
    assert_difference('Ledger.count') do
      post ledgers_url, params: { ledger: { comment_id: @ledger.comment_id, provider_id: @ledger.provider_id } }, as: :json
    end
  ...
  test "should update ledger" do
    patch ledger_url(@ledger), params: { ledger: { comment_id: @ledger.comment_id, provider_id: @ledger.provider_id } }, as: :json
    assert_response 200
  end
